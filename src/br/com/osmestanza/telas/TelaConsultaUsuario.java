...
public class TelaConsultaUsuario extends javax.swing.JInternalFrame {
    ...
    private void consultar() {
        ...
        String sql = "SELECT Nome_Usuario AS 'Nome', Login_Usuario AS 'Login', Fone_Usuario AS 'Telefone', Perfil_Usuario AS 'Perfil' FROM tbl_Usuarios WHERE Nome_Usuario LIKE ?;";
        try {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(txtConsultar, javax.swing.GroupLayout.PREFERRED_SIZE, 475, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(64, 64, 64)
